 ...
 * string paths like '#/map', '#/create', '#/settlements', '#/duplicates', '#/upload', '#/files',
 * '#/export'.
 */
export type Route =
  | 'map'
...
const ROUTES: Route[] = ['map', 'create', 'settlements', 'duplicates', 'upload', 'files', 'export', 'guide', 'settings'];
